"""
Mask R-CNN
Train on the toy baloon dataset and implement color splash effect.
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect tumors.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="C:\\Users\\dell\\Downloads\\Mask_RCNN-master\\samples\\tumor\\dataset",
                        help='Directory of the tumor dataset')
